...
<body>
    <div class="container">
        ...
        <div id="links" style="display:none;">
            <a href="https://ai-model-gallery.railway.app/" class="btn" target="_blank">
                🏠 메인 페이지 확인
            </a>
            <a href="https://ai-model-gallery.railway.app/admin/images" class="btn btn-admin" target="_blank">
                📱 어드민 페이지 테스트
            </a>
        </div>
    </div>
