  ...
  useEffect(() => {
    ...
    if (uploadedModel) {
      ...
      setModel({
        ...
        mediaUrl: uploadedModel.url,
        originalUrl: uploadedModel.originalUrl,
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="relative">
              {model.type === 'video' ? (
                <VideoPlayer
                  src={resolvedMediaSource || model.mediaUrl}
                  width={model.width}
                  height={model.height}
                ...
                >
                  <Image
                    src={resolvedMediaSource || model.originalUrl || model.mediaUrl}
                    alt={model.name}
                    width={model.width}
                    height={model.height}
